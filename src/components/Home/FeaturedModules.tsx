...
import { featuredModules } from '../../lib/mockData';
...
const FeaturedModules: React.FC = () => (
  <section className="mb-8" aria-label="Continue Learning">
    <div className="flex justify-between items-center mb-4">
      ...
      <button className="text-[#2E5A1C] text-sm font-medium cursor-pointer" aria-label="View all featured modules">View All</button>
    </div>
